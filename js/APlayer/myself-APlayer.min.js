    ...
    function (e, t) {
        ...
        return function (e) {
                ...
                return i(e, [{
                    ...
                    value: function (e) {
                        this.player.events.trigger("listadd", {
                            ...
                            return e.name = e.src || e.title || "Audio name", e.artist = e.artist || e.author || "Audio artist", e.cover = e.cover || e.pic, e.type = e.type || "normal", e
                        });
                    ...
                    value: function (e) {
                        if (this.player.events.trigger("listswitch", {
                            ...
                            //当前播放
                            $(".aplayer-title").attr("music-src",t.url);
                            ...
                            n && n.classList.remove("aplayer-list-light"),
                                this.player.container.querySelectorAll(".aplayer-list li")[this.index].classList.add("aplayer-list-light"), (0, o.default)                                  (33 * this.index, 500, null,this.player.template.listOl),
                    ...
                    value: function (e) {
                        ...
                        if (!this.parsed[e]) if (this.async) {
                            ...
                            n.onreadystatechange = function () {
                                ...
                                e === t.player.list.index && 4 === n.readyState && (n.status >= 200 && n.status < 300 || 304 === n.status ? t.parsed[e] = t.parse(n.responseText) : (t.player.notice("LRC歌词文件获取失败 " + n.status), t.parsed[e] = [
                                    ["00:00", "~暂未找到歌词~"]
            ...
            e.exports = function (e) {
                ...
                return a.fixed ? (t += '\n<div class="aplayer-list', a.listFolded && (t += " aplayer-list-hide"), t += '"', a.listMaxHeight && (t += ' style="max-height: ', t += o(a.listMaxHeight), t += '"'), t += ">\n    <ol", a.listMaxHeight && (t += ' style="max-height: ', t += o(a.listMaxHeight), t += '"'), t += ">", l(n(1)(u({
                    theme: a.theme,
                    audio: a.audio,
                    index: 1
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                var t = {
                    ...
                    volume: .7,
                    listFolded: e.fixed,
                    listMaxHeight: e.listmaxheight || "1100px",//列表高度
                    audio: e.music || [],
                    storageName: "meting-js"
                };
                ...
                g = function () {
                    function e(t) {
                        ...
                        this.template = new l.default({
                            ...
                            player: this
                        })), this.events = new y.default, this.storage = new c.default(this), this.bar = new u.default(this.template), this.controller = new d.default(this), this.timer = new h.default(this), this.list = new f.default(this), this.initAudio(), this.bindEvents(), "random" === this.options.order ? this.list.switch(this.randomOrder[0]) :
                    ...
                    return i(e, [{
                        ...
                        value: function () {
                            ...
                            this.on("error", function () {
                                e.list.audios.length > 1 ? (e.notice("音频获取失败，2秒后切换下一曲。"), t = setTimeout(function () {
                                ...
                                }, 2e3)) : 1 === e.list.audios.length && e.notice("音频获取失败。")
                        ...
                        value: function (e) {
                            ...
                            var t = e.type;
                            this.options.customAudioType && this.options.customAudioType[t] ? "[object Function]" === Object.prototype.toString.call(this.options.customAudioType[t]) ? this.options.customAudioType[t](this.audio, e, this) : console.error("Illegal customType: " + t) : (t && "auto" !== t || (t = /m3u8(#|\?|$)/i.exec(e.url) ? "hls" : "normal"), "hls" === t ? Hls.isSupported() ? (this.hls = new Hls, this.hls.loadSource(e.url),
                                this.hls.attachMedia(this.audio)) : this.audio.canPlayType("application/x-mpegURL") || this.audio.canPlayType("application/vnd.apple.mpegURL") ? this.audio.src = e.url : this.notice("Error: HLS is not supported.") : "normal" === t && (this.audio.src = e.url)), this.seek(0), this.paused || this.audio.play()
                        }
                    }, {
                        key: "theme",
                        value: function () {
